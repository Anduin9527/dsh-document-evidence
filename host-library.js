...
export function applyLibrary(ctx, config) {
  ...
  const register = (name, description, parameters, operation, transform) => {
    ...
    name, description, parameters, output: { schema: { type: 'json' },
